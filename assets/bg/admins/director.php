    ...
    <div class="content">
        ...
        <div class="content-bar">
            ...
            <div class="path-bar">
                ...
                <div class="url-path">الاداره </div>
                <button onclick="window.open('http://localhost/ecomweb/assets/pg/admins/add_admin.php','_self');">اضف مدير </button>
            ...
            <table class= "table table-bordered" role="table">
                <thead>
                    <tr>
                        <th width="2%">#</th>
                        <th class="text-right" width="15%">أسم المدير </th>
                        <th class="text-right" width="15%">الايميل  </th>
