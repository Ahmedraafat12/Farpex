    ...
    <div class="content">
        ...
        <div class="content-bar">
            ...
            <div class="path-bar">
                ...
                <button onclick="window.open('http://localhost/ecomweb/assets/pg/admins/add_discount.php','_self');">اضف خصم جديد</button>
            ...
            <table class= "table table-bordered" role="table">
                <thead>
                    <tr>
                        <th width="2%">#</th>
                        <th class="text-right" width="15%">كود الخصم</th>
