    ...
    <div class="content">
        ...
        <div class="content-bar">
            ...
            <div class="path-bar">
                ...
                <button onclick="window.open('http://localhost/ecomweb/assets/pg/admins/add_product.php','_self');">اضف منتج جديد</button>
            ...
            <table class="table table-bordered" role="table">
                <thead>
                    <tr>
                        ...
                        <th class="text-right" width="10%">عدد المبيعات</th>
                        <th class="text-right" width="10%">عدد التقييمات</th>
                        <th class="text-right" width="10%">نوع القسم</th>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()){
                        echo  
                        '<tr>
                            <td><span class= "badge">'.$row["id"].'</spen></td>
                            <td>'.$row["title"].'</td>
                            <td>'.$row["old_price"].'</td>
                            <td>'.$row["price"].'</td>
                            <td>1</td>
                            <td> <a href="http://localhost/ecom/home/show/4" target="_blanck">0</a></th>
                            <td>'.$row["cat_type"].'</th>
                            <td date-title="التحكم" class="text-center">
                                <a href="assets/pg/admins/edit_product.php?prd_id='.$row["id"].'" class="edit-btn" > التعديل</a>
                                <a href="del_product?del_id='.$row["id"].'" class="del-btn">حذف</a>
                            </td>                          
                        </tr>';
                    }
                    ?>
