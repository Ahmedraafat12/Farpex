...
<body>
    ...
    <div class="content">
        ...
        <div class="content-bar">
            ...
            // $sql = "SELECT * FROM category ORDER BY listorder ASC";
            $sql = "SELECT * FROM category ORDER BY list_num ASC ";
    ...
    <div class="content">
        ...
        <div class="content-bar">
            ...
            <div class="path-bar">
                ...
                <button onclick="window.open('http://localhost/ecomweb/assets/pg/admins/add_cat.php','_self');">اضف قسم جديد </button>
            </div>
            <?php
