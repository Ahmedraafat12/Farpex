        ...
        <div class="show_prd">
            <div class="first_div">
                ...
                <div class="price_shw_prd">
                    <s class="old_price_shw_prd"><?php echo $row["old_price"]."SAR";?>
                    </s>
                ...
                <div class="quantity-box">
                    ...
                    <div class="quantity-sys">
                        ...
                        <input style="text-align:center;" id="input-num" type="text" value="1" onkeyup="check_num();">
                ...
                <form style="width:100%;" action="order_now?id=<?php echo $prd_id; ?>" method="post">
                    ...
                    <div class="center-btn">
                        <button type="submit" class="order-now" >اطلب الآن</button>
                    </div> 
                </form>  
                <div class="shipping_info"  style="font-size: 18px; margin: 30px 0 10px 0; "><?php  echo $row["shipping_info"];?></div>
                <div  class="description" style="font-size: 18px; margin: 30px 0 10px 0; border: 1px solid #ccc; background-color:#efefef ; padding: 20px 10px; "><?php  echo htmlspecialchars_decode($row["disc"]) ;?></div>
